export default function Header() {
  return (
    <div className="relative isolate px-6 pt-0 lg:px-8">
      <div
        aria-hidden="true"
        className="absolute inset-x-0 -top-40 -z-50 transform-gpu overflow-hidden blur-3xl sm:-top-0"
      >
        <div
          style={{
            clipPath:
      ...
      <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <div className="text-center">
          ...
          <p className="mt-8 text-pretty text-md font-medium text-gray-500 sm:text-xl/8">
            Get expert medical advice from the comfort of your home. Connect
            with certified doctors anytime, anywhere.
          </p>
